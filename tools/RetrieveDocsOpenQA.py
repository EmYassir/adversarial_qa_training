...
from src.utilities.Retriever.DPR import DPRRetreiver
...
def get_args():
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="Path to huggingface dataset of corpus.",
    )
    parser.add_argument(
        "--cache_dir",
        required=True,
    ...
    parser.add_argument(
        "--index_path",
        type=str,
        help="Path to saved index used by a Retriever. If index path not set, Retriever searches in the output_dir for the index.",
    )
    parser.add_argument(
        "--world_size",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=512,
        help="Batch size to use for encoding in GPUs. Not used in BM25 Retiever",
    )
    parser.add_argument(
        "--ignore_cache_dirs",
        action="store_true",
